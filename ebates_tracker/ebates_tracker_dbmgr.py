...
class EbatesTrackerDBMgr(object):
    """database manager for EbatesTracker
    """
    conn = None
    connected = False
    cursor = None

    def __init__(self, dbname='.EbatesTracker.db'):
        """init database
        """
...
if __name__ == '__main__':
    print('This file contains database manager class for EbatesTracker')
